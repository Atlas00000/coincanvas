...
import { Diamond, Mail, Lock, Eye, EyeOff, ArrowRight, Shield, Sparkles, Crown, User, Phone, Check } from "lucide-react"
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 text-foreground overflow-hidden relative flex items-center justify-center py-12">
      <FloatingParticles />
      ...
      <div className="container mx-auto px-6 pt-20">
        <div className="max-w-lg mx-auto">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Join the Elite</h1>
            <p className="text-muted-foreground">Create your premium trading account</p>
          </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {formData.password && (
                      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span
                            className={`font-medium ${passwordStrength >= 4 ? "text-green-500" : passwordStrength >= 3 ? "text-yellow-500" : "text-red-500"}`}
                          >
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        ...
                        className="border-border data-[state=checked]:bg-amber-500 data-[state=checked]:border-amber-500 mt-1"
                      />
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      >
                        I would like to receive marketing communications about elite features and exclusive offers
                      </Label>
                    </div>
                  </motion.div>
                  ...
                  >
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-white py-3 text-lg shadow-lg relative overflow-hidden group disabled:opacity-50"
                    >
                      <motion.div
                      ...
                      {isLoading ? (
                        ...
                        <>
                          <span className="relative z-10">Create Elite Account</span>
                          <motion.div
                            animate={{ x: [0, 5, 0] }}
